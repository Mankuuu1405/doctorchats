        ...
        <div className='grid grid-cols-1 md:grid-cols-4 gap-12'>
          ...
          <div>
            ...
            <div className='flex gap-4'>
                ...
                <a href="https://www.instagram.com/cywala_/?igsh=MXIzZmU4Z256OThiOA%3D%3D#" className='text-gray-500 hover:text-teal-600 transition-colors duration-300'><TwitterIcon /></a>
